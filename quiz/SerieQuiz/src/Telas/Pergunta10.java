...
public class Pergunta10 extends JFrame {
	...
	public Pergunta10() {
		...
		JRadioButton opcao04 = new JRadioButton("6 anos ");
		...
		JRadioButton opcao03 = new JRadioButton("5 anos ");
		...
		JRadioButton opcao02 = new JRadioButton("7 anos ");
		...
		JRadioButton opcao01 = new JRadioButton("1 ano");
		...
		JLabel lblQualO = new JLabel("Quantos anos Oliver ficou desaparecido?");
		lblQualO.setForeground(Color.WHITE);
		lblQualO.setFont(new Font("Century Gothic", Font.BOLD, 17));
		lblQualO.setBounds(28, 11, 365, 45);
		panel.add(lblQualO);
				 ...
				 if(bgGrupo.isSelected(null)) {
				  ...
				  if(opcao03.isSelected()) {
				   Pontos.acerto();
						...
						Pontuacao janela = new Pontuacao();
		...
		label.setIcon(new ImageIcon(Pergunta10.class.getResource("/img/arrow.png")));
