...
import Telas.Pergunta07;
import Telas.Pontos;
import Telas.TelaPrincipalQuiz;

public class Pergunta06 extends JFrame {
	...
	public Pergunta06() {
		...
		JRadioButton opcao04 = new JRadioButton("Theo Putman");
		...
		JRadioButton opcao03 = new JRadioButton("Richard Coyle");
		...
		JRadioButton opcao02 = new JRadioButton("Harvey Kinkler");
		...
		JRadioButton opcao01 = new JRadioButton("Ross lynch");
		...
		JLabel lblQualO = new JLabel("Quem foi o primeiro namorado de Sabrina?");
				 ...
				 if(bgGrupo.isSelected(null)) {
				  ...
				  if(opcao04.isSelected()) {
				   Pontos.acerto();
						...
						Pergunta07 janela = new Pergunta07();
						janela.setVisible(true);
						Pergunta06.this.dispose();
					}
