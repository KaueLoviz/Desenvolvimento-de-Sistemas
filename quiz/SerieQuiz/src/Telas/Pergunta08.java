...
public class Pergunta08 extends JFrame {
	...
	public Pergunta08() {
		...
		JRadioButton opcao04 = new JRadioButton("Vivian");
		...
		JRadioButton opcao03 = new JRadioButton("Gina");
		...
		JRadioButton opcao02 = new JRadioButton("Genevive\r\n");
		...
		JRadioButton opcao01 = new JRadioButton("Rosa");
		...
		JLabel lblQualO = new JLabel("Por quem Boyle era apaixonado no in\u00EDcio da s\u00E9rie?");
		lblQualO.setForeground(Color.WHITE);
		lblQualO.setFont(new Font("Century Gothic", Font.BOLD, 15));
				 ...
				 if(bgGrupo.isSelected(null)) {
				  ...
				  if(opcao01.isSelected()) {
				   Pontos.acerto();
						...
						Pergunta09 janela = new Pergunta09();
